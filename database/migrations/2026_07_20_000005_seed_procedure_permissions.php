...
{
    /** Гранты прав и видимости меню «Процедуры» по дефолтам каталога (config/permissions.php). */
    private const KEYS = ['menu.processes.procedures', 'procedures.start', 'procedures.view_all', 'procedures.manage'];
