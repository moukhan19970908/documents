<x-app-layout>
    ...
    <div class="max-w-2xl" x-data="routeForm({ steps: [{ approver_role_level: 1, approver_user_id: '' }] })">
        ...
        <form action="{{ route('admin.approval-routes.store') }}" method="POST" class="space-y-5">
            @csrf
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required
                           ...
                           placeholder="Базовый маршрут командировок">
                </div>
